...
def plot_latency_comparison(exact_df, hll_df):
    ...
    plt.tight_layout()
    plt.savefig('plot_latency_comparison.png', dpi=300, bbox_inches='tight')
    print("✓ Saved: plot_latency_comparison.png")
    plt.close()
...
def plot_accuracy_vs_storage(hll_df):
    ...
    plt.tight_layout()
    plt.savefig('plot_accuracy_storage_tradeoff.png', dpi=300, bbox_inches='tight')
    print("✓ Saved: plot_accuracy_storage_tradeoff.png")
    plt.close()
...
def plot_speedup_vs_error(exact_df, hll_df):
    ...
    plt.tight_layout()
    plt.savefig('plot_speedup_vs_error.png', dpi=300, bbox_inches='tight')
    print("✓ Saved: plot_speedup_vs_error.png")
    plt.close()
...
def main():
    ...
    print("  Files: plot_latency_comparison.png")
    print("         plot_accuracy_storage_tradeoff.png")
    print("         plot_speedup_vs_error.png")
